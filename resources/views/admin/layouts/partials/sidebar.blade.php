...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('technology.add') }}">Add</a>
            <a class="collapse-item" href="{{ route('technology.home') }}">View</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="question" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('question.add') }}">Add</a>
            <a class="collapse-item" href="{{ route('question.home') }}">View</a>
        </div>
    </div>
</li>
...
<div class="sidebar-card d-none d-lg-flex">
    <img class="sidebar-card-illustration mb-2" src="{{ asset('public/img/undraw_rocket.svg')}}" alt="...">
